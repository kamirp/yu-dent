...
class MainWindow(QMainWindow):
    ...
    def create_menu(self):
        ...
        # --- Перенос пациентов ---
        transfer_action = QAction("Перенос пациентов", self)
        transfer_action.triggered.connect(self.open_transfer_patients)
        registry_menu.addAction(transfer_action)
    ...
    # ================== ПЕРЕНОС ПАЦИЕНТОВ ==================
    def open_transfer_patients(self):
        """
        Экран переноса пациентов.
        Логику и виджеты ты реализуешь в отдельном файле.
        """
        from ui.transfer.transfer_window import TransferWindow

        self.setCentralWidget(TransferWindow(self))
